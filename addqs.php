            ...
            <section id="ans">
                <center>
                    <form style="margin: 0vw;width: 100vw" method="post">
                        ...
                        <input type="submit" name="submit" value="Add one more question" style="height: 3vw;width: auto;font-family: 'Courier New', Courier, monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
                    ...
                    <br>    
                    <a href="homestaff.php"><input type="submit" name="cancel" value="Cancel" style="height: 3vw;width: auto;font-family: 'Courier New', Courier, monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;"></a>
