...
<style>
    ...
    button:hover {
        background-color: #92f09c !important;
    }
...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Courier New', Courier, monospace;height:auto;color:#fff">
    <div style="background-color: #fce5e3;height: auto;color:#fff !important">
        ...
        <center>
            <section style="width:100vw;margin:0vw;margin-top:4vw;font-size:2vw;color: #000;">Welcome to Online Examination System&nbsp;<?php echo $dbname ?></section>
        </center>
        <section class="dash" style="margin: 5vw;width: 90vw;">
            <center>
                <h1 style="font-weight:bolder;font-size:3vw;color: #2385fc;">Dashbord</h1>
            </center>
            ...
            <center>
                <section id="addq" style="display:none; ">
                    <form style="width: 30vw" method="post">
                        ...
                        <label for="quizname" style="color:#000;">Quiz name</label><br><br>
        ...
        <section id="score" style="display:none;">
            ...
            $res = mysqli_query($conn, $sql);
            if ($res) {
                echo "<h1>List of Quiz added by you:</h1>";
